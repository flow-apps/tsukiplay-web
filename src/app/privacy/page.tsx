      ...
      <main className={styles.container}>
        <div id={styles.content}>
          ...
          <p>
            ...
            TsukiPlay respeitar a sua privacidade em relação a qualquer
            informação sua que possamos coletar no site{" "}
            <a
              href="https://tsukiplay.vercel.app/"
              target="_blank"
              rel="noopener"
            >
              TsukiPlay
          ...
          <p>
            ...
            terceiros. Esteja ciente de que não temos controle sobre o conteúdo
            e práticas de sites de terceiros e não podemos aceitar
          ...
          <p>
            ...
            informações pessoais, entre em contato conosco através do e-mail
            pedrobraga693@gmail.com.
          </p>
          ...
          <p>
            ...
            TsukiPlay, independente de aviso ou notificação. Em caso de
            alteração, as modificações produzem todos os efeitos a partir do
            momento da disponibilização no site.{" "}
          </p>

          <p>
            O site TsukiPlay não se responsabiliza caso você venha utilizar seus
          ...
          <p>
            ...
            informação que o site TsukiPlay oferece e com caráter enunciativo,
            mas não limitativo:
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              xenofóbica, casas de apostas, jogos de sorte e azar, qualquer tipo
              de pornografia ilegal, de apologia ao terrorismo ou contra os
              direitos humanos;
            </li>
            <li>
              D) Não causar danos aos sistemas físicos (hardwares) e lógicos
              (softwares) do site TsukiPlay, de seus fornecedores ou terceiros,
            ...
            <li>
              ...
              Direitos Autorais n. 9.610, de 19.2.1998 do Governo Federal
              Brasileiro e correlatas. Qualquer infringência, serão comunicados
          ...
          <p>
            ...
            TsukiPlay, através do canal específico de tratamento, a qualquer
          ...
          <p>
            ...
            dentro de um prazo de 72 horas, salvo determinação legal e/ou objeto
            de lei.
          </p>
          ...
          <p>
            O site TsukiPlay empregará esforços para resguardar as informações e
            dados coletados do usuário pelo site. Todavia, considerando que não
            há meio de transmissão e retenção de dados eletrônicos plenamente
            eficaz e seguro, o site TsukiPlay não pode assegurar que terceiros
            ...
            conduta de terceiros, ataques externos ao site como: vírus, invasão
            ao banco de dados, vícios ou defeitos técnicos, assim como
            operacionais resultante da utilização do site e em razão de falhas
            de conexão.
          </p>
        </div>
      </main>
